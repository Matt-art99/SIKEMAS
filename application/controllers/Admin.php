...
class Admin extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['pengaduan'] = $this->db->count_all('pengaduan');
    $data['masyarakat'] = $this->db->count_all('masyarakat');
    $data['proses'] = $this->db->get_where('pengaduan', ['status' => 'proses'])->num_rows();
    $data['selesai'] = $this->db->get_where('pengaduan', ['status' => 'selesai'])->num_rows();
  ...
  public function tambah()
  {
    ...
    $this->form_validation->set_rules(
      'username',
      'Username',
      'required|trim|min_length[5]|is_unique[petugas.username]',
      [
