        ...
        <table class="table table-hover" id="example" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-primary btn-sm mt-2" href="<?= base_url('petugas/editDataPenduduk/') . $p['nik']; ?>">
                  <i class="fas fa-fw fa-edit"></i>
                </a>
                <a onclick="return confirm('Yakin?');" class="btn btn-danger btn-sm mt-2" href="<?= base_url('petugas/hapusDataPenduduk/');?><?= $p['nik']; ?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('petugas/tambahDataPenduduk'); ?>" method="post">
